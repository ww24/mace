 ...
 * license: MIT
 */
(function(){"use strict";var e;e=function(){function e(e,t,n){var r;this.editor=e,this.preview=null!=t?t:null,null==n&&(n={}),r=this,this.Ace={Range:ace.require("ace/range").Range},this.ace=ace.edit(this.editor),this.ace.getSession().setMode("ace/mode/markdown"),this.ace.setTheme("ace/theme/monokai"),marked.setOptions({renderer:new marked.Renderer,gfm:!0,tables:!0,breaks:!0,pedantic:!1,sanitize:!0,smartLists:!0,smartypants:!1}),null!==this.preview&&(this._render(),this.ace.on("change",function(e){return function(){return e._render()}}(this))),Object.defineProperty(this,"value",{get:function(){return this.ace.getValue()}}),Object.defineProperty(this,"font_size",{get:function(){return this.ace.getFontSize()},set:function(e){return this.ace.setFontSize(e)}})}return e.prototype._render=function(){var e;return e=this.ace.getValue(),marked(e,function(e){return function(t,n){return null!=t&&console.error(t),e.preview.innerHTML=n}}(this))},e.prototype._getCurrentRage=function(){var e;return e=this.ace.selection.getRange(),this.ace.selection.clearSelection(),0===e.end.column&&e.end.row-e.start.row===1&&e.end.row--,e},e.prototype.indent=function(e){var t,n;for(null==e&&(e=1),t=n=0;e>=0?e>n:n>e;t=e>=0?++n:--n)this.ace.indent();return this.ace.focus()},e.prototype.outdent=function(e){var t,n;for(null==e&&(e=1),t=n=0;e>=0?e>n:n>e;t=e>=0?++n:--n)this.ace.blockOutdent();return this.ace.focus()},e.prototype.heading=function(e){var t,n,r,o,i,s,c,a,u,h,l;if(null==e&&(e=1),0>e||e>6)throw new RangeError;for(r=this.ace.getCursorPosition(),o=this._getCurrentRage(),i=c=u=o.start.row,h=o.end.row;h>=u?h>=c:c>=h;i=h>=u?++c:--c)if(this.ace.moveCursorTo(i,0),s=this.getLineText(i),t=(null!=(l=s.match(/^#+/i))?l[0].length:void 0)||0,t!==e)for(n=a=t;e>=t?e>a:a>e;n=e>=t?++a:--a)e>t?this.ace.insert("#"):this.ace.remove("right");return this.ace.moveCursorTo(r.row,r.column+e-t),this.ace.focus()},e.prototype.link=function(e,t,n,r){var o,i;return null==e&&(e="./"),null==n&&(n=""),null==r&&(r=!1),i=this.ace.getCopyText().split("\n").join(""),t=t||i||"link",n.length>0&&(n=' "'+n+'"'),o=["","!"][+r],this.ace.insert(""+o+"["+t+"]("+e+n+")"),this.ace.focus()},e.prototype.getLineText=function(e){var t,n,r;return n=this.ace.getCursorPosition(),e=e||n.row,this.ace.moveCursorTo(e,0),this.ace.navigateLineEnd(),t=this.ace.getCursorPosition(),this.ace.selection.addRange(new this.Ace.Range(t.row,0,t.row,t.column)),r=this.ace.getCopyText(),this.ace.selection.clearSelection(),this.ace.moveCursorTo(n.row,n.column),r},e.prototype.list=function(e){var t,n,r,o,i,s,c,a,u,h,l;for(null==e&&(e="-"),o=this.ace.getCursorPosition(),i=this._getCurrentRage(),s=u=h=i.start.row,l=i.end.row;l>=h?l>=u:u>=l;s=l>=h?++u:--u)this.ace.moveCursorTo(s,0),a=this.getLineText(s),r=a.match(/^(\s*)[*-](\s*)[^*-][^]+/i),n=null!==r,n?(t=null!=r?r[1].length:void 0,this.ace.moveCursorTo(s,t),c=null!=r?r[2].length:void 0,this.ace.selection.addRange(new this.Ace.Range(s,0,s,c+1)),this.ace.remove("right")):this.ace.insert(""+e+" ");return this.ace.moveCursorTo(o.row,o.column+2),this.ace.focus()},e.prototype.code=function(e,t){var n,r,o,i;return null==e&&(e=""),null==t&&(t=""),r=this.ace.getCursorPosition(),i=this.ace.getCopyText(),~i.indexOf("\n")?(o=this._getCurrentRage(),n=1,this.ace.moveCursorTo(o.start.row,o.start.column),this.ace.insert("```"+t+"\n"),this.ace.moveCursorTo(o.end.row+n,o.end.column),0!==o.end.column&&(this.ace.insert("\n"),n++),this.ace.insert("```\n"),this.ace.moveCursorTo(o.end.row+n+1,0)):(i=i.split("\n").join(""),i?(this.ace.remove("right"),this.ace.insert("`"+i+"`")):(this.ace.insert("```"+t+"\n"+e+"\n```\n"),e?this.ace.moveCursorTo(r.row+e.split("\n").length+3,0):this.ace.moveCursorTo(r.row+1,0))),this.ace.focus()},e.prototype.clear=function(e){return null==e&&(e=!1),e?this.ace.setValue(""):this.ace.removeLines()},e}(),this.Mace=e}).call(this);
/**
